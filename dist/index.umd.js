(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@apollo/client'), require('firebase/app'), require('firebase/auth'), require('firebase/storage'), require('@apollo/client/link/context'), require('ethers'), require('@firebase/auth')) :
  typeof define === 'function' && define.amd ? define(['exports', '@apollo/client', 'firebase/app', 'firebase/auth', 'firebase/storage', '@apollo/client/link/context', 'ethers', '@firebase/auth'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.earnallianceClient = {}, global.client, global.app, global.auth, global.storage, global.context, global.ethers, global.auth$1));
})(this, (function (exports, client, app, auth, storage, context, ethers, auth$1) { 'use strict';
